...
class TransactionList extends Component {
    ...
    render() {
        ...
        const ProductData = [
            {
                id: 1,
                product_image:"https://cdn.pixabay.com/photo/2020/10/21/18/07/laptop-5673901_960_720.jpg",
                                    ...
                                    <div className="container-fluid">
                                        <div className="row">
                                            <div className="col-4 text-center">
                                                <img className="cart-image" src="https://cdn.pixabay.com/photo/2020/10/21/18/07/laptop-5673901_960_720.jpg"/>
                                            </div>
                                            <div className="col-4 text-center">
